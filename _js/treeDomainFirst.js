...
function domainFirst(gradeDomainSwitch, viewerWidth, viewerHeight){
...
treeJSON = d3.text("./_data/flareDomainFirst.txt", function(error, treeData) {
    ...
    // size of the diagram
    /*var viewerWidth = $(document).width()-75;
   ...
   // Toggle children on click.
    function click(d) {
        ...
        } else if (d.type == "domain") { // clicked node is a domain
            $(".hover-text").remove(); // clear the hover text div of any old content when clicking any nodes besides the leaf
  ...
  /*      node.select('text')
        ...
        node.select("circle.nodeCircle")
            ...
            .style("stroke", function(d){
                if (d.type == "grade") { // only the leaf has the standardText, so this check works                    
                    ...
                    else if (d.parent.parent.name == "Grade: 1") { return "#95f4e9";}
                    else if (d.parent.parent.name == "Grade: 2") { return "#33ccd3";}
                    else if (d.parent.parent.name == "Grade: 3") { return "#71abff";}
                    else if (d.parent.parent.name == "Grade: 4") { return "#3232c9";}
                    else if (d.parent.parent.name == "Grade: 5") { return "#1717a0";}
                    else if (d.parent.parent.name == "Grade: 6 - 8") { return "#e28bf7";}
                    else if (d.parent.parent.name == "Grade: 6") { return "#ae76ff";}
                    else if (d.parent.parent.name == "Grade: 7") { return "#7228c9";}
                    else if (d.parent.parent.name == "Grade: 8") { return "#c61ae5";}
                    else if (d.parent.parent.name == "Grade: 9 - 10") { return "#a3e867";}
                    else if (d.parent.parent.name == "Grade: 11 - 12") { return "#39b54a";}
                    else if (d.parent.parent.name == "Grade: HSN") { return "#a3e867";}
                    else if (d.parent.parent.name == "Grade: HSA") { return "#39b54a";}
                    else if (d.parent.parent.name == "Grade: HSF") { return "#1fa087";}
                    else if (d.parent.parent.name == "Grade: HSG") { return "#1b6d20";}
                    else if (d.parent.parent.name == "Grade: HSS") { return "#1a511a";}                
                } else {
                    return "#4a4f4f";
                }
            });
    ...
    $(".gradeDomainSwitch").prepend("<h4><small id='gradeDomainSwitch'>Showing Domain First</small></h4>")
    ...
    $("#secondLevel").text("Domain");
    $("#thirdLevel").text("Grade");    
    ...
    function populateGrades(key){
        ...
        var gradeLabels = ['select a domain'];
